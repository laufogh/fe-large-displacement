...
!       and Geotechnics 35 (2008) 500–503]", Computers and Geotechnics, 2009,
...
!--------------------------------------------------------------------
      ...
      integer(4) i, j
      integer, dimension(3), parameter :: Hj1 = [1, 3, 2]
	integer, dimension(3), parameter :: Hj2 = [2, 1, 3]
