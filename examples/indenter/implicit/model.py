...
This file is complete. Read it top to bottom. The other folders in
examples/indenter/ are the same model with the extra lines that each
formulation needs.
"""
...
chk.requires(r'^\*Step,.*nlgeom=YES', 'geometrically nonlinear')
